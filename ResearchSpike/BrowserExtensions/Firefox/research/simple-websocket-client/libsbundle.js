...
console.log(buffer);
// console.log("abouyt to")
// console.log(new Buffer("lol"))

validate = function(redirectURL) {
  // validate the access token
  console.log("here121");
  console.log("bruhhere", redirectURL);
  ...
  if (state === null || state !== storedState) {
    ...
    fetch("https://accounts.spotify.com/api/token", {
      ...
      headers: {
        ...
        Authorization:
          "Basic " +
          new Buffer(Oauth.client_id + ":" + Oauth.client_secret).toString(
            "base64"
          )
      },
      form: {
      ...
      .then(data => console.log("OMG WOW: ", data));
...
var storedState;
authorize = function() {
  // let redirectURL = browser.identity.getRedirectURL(); //'http://localhost:80/callback'
  console.log("this will be the redirect url:", Oauth.redirect_uri);
  ...
  authURL += `&client_id=${Oauth.client_id}`;
  authURL += `&scope=${encodeURIComponent(scope)}`;
  authURL += `&redirect_uri=${encodeURIComponent(Oauth.redirect_uri)}`;
